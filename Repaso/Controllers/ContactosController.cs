...
namespace Repaso.Controllers
{
    public class ContactosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombres,Apellidos,Email,Telefono,Mensaje")] Contactos contactos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombres,Apellidos,Email,Telefono,Mensaje")] Contactos contactos)
        {
            if (ModelState.IsValid)
            {
